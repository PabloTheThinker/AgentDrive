...
# Usage:
#   iwr https://raw.githubusercontent.com/PabloTheThinker/AgentDrive/main/scripts/install.ps1 -UseBasicParsing | iex
...
Write-Host ""
Write-Host "Documentation: https://github.com/PabloTheThinker/AgentDrive" -ForegroundColor DarkGray
