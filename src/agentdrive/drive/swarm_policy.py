...
class SwarmDrivePolicy:
    ...
    # v2 / Milestone 2a: default is "swarm" — all sub-agents in the same swarm
    # share one Drive and learn from each other freely. Sub-agents namespace
    # their writes via the Genome author field; reads are unrestricted across
    # siblings. Use "subagent" only for air-gapped red-team / adversarial
    # children that must not see other agents' work.
    isolation_level: IsolationLevel = "swarm"
    ...
    # v2 / Milestone 2a: siblings share the swarm Drive by default. "none"
    # remains opt-in for the rare adversarial-child case.
