...
6. ledger.py             → Ledger, LedgerEntry, log_entry, audited,
   ...
   Why: "Maintaining audit ledgers for genomes". Every extraction,
        ...
        ~/.savant/reasoning/ledger/ . Provides the raw material for
...
- Default storage paths use ~/.savant/reasoning/...
...
Scanners (src/savant/scanners/*.py) and the future evolutionary engine
(src/savant/evolution/) should import from here:
...
Example usage in a future DNA Scanner:
    ...
    from savant.reasoning import ReasoningEngine
...
# Re-export all public symbols from the 8 modules so "import savant.reasoning"
