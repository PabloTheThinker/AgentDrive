...
- **DNA = Memory + Patterns** (Assassin's Creed style): Every sub-agent's experience (successful frameworks, reasoning traces, tool compositions, outcomes) becomes portable, versioned, forkable DNA.
