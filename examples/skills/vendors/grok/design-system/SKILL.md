...
description: "Ingest, parse, generate, and maintain DESIGN.md design systems and tokens from codebases, CSS, screenshots, design files, or descriptions. Use when building or updating UI with consistent brand (colors, typography, components, patterns). Extracts tokens, creates living contracts, ensures all generations follow the system like Claude Design."
category: vendors
harness: grok
