...
description: "Build production-grade web artifacts (self-contained HTML/Tailwind for live preview, or React/TSX components) with strong architecture, component composition, responsiveness, accessibility, dark mode, and state management. Use for generating interactive prototypes, dashboards, pages, or UI kits that can be previewed live (like Claude Artifacts) or handed off cleanly. Pair with frontend-design and design-system skills."
category: vendors
harness: grok
...
backup_path: /home/pablothethinker/.grok/skills/artifacts-builder/SKILL.md
when_to_call: when running on the grok harness with its native tools; use universal/* via MCP otherwise
---

# grok-artifacts-builder (grok harness)
