---
name: codex-yeet
description: "Fast branch-and-PR publish flow from Codex when changes are ready to ship."
category: vendors
harness: codex
...
backup_of: yeet
backup_path: /home/pablothethinker/.codex/plugins/cache/openai-curated/github/3f0def1b/skills/yeet/SKILL.md
when_to_call: when running on the codex harness with its native tools; use universal/* via MCP otherwise
---

# codex-yeet (codex harness)
