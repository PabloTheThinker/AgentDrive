---
name: codex-github
description: "Codex GitHub triage — repos, PRs, issues via connector; route to specialist workflows."
category: vendors
harness: codex
...
backup_of: github
backup_path: /home/pablothethinker/.codex/plugins/cache/openai-curated/github/3f0def1b/skills/github/SKILL.md
when_to_call: when running on the codex harness with its native tools; use universal/* via MCP otherwise
---

# codex-github (codex harness)
