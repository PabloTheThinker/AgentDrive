---
name: codex-gh-fix-ci
description: "Diagnose and fix failing GitHub Actions CI from Codex."
category: vendors
harness: codex
...
backup_of: gh-fix-ci
backup_path: /home/pablothethinker/.codex/plugins/cache/openai-curated/github/3f0def1b/skills/gh-fix-ci/SKILL.md
when_to_call: when running on the codex harness with its native tools; use universal/* via MCP otherwise
---

# codex-gh-fix-ci (codex harness)
