...
description: "Claude Code plugin layout — commands, agents, skills, hooks, MCP wiring."
category: vendors
harness: claude
requires: "Claude Code plugin runtime"
role: shared
tags: [claude, vendor, harness]
backup_of: plugin-structure
backup_path: /home/pablothethinker/.claude/plugins/marketplaces/claude-plugins-official/plugins/plugin-dev/skills/plugin-structure/SKILL.md
when_to_call: when running on the claude harness with its native tools; use universal/* via MCP otherwise
---

# claude-plugin-structure (claude harness)
