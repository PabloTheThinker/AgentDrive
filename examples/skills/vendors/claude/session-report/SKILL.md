---
name: claude-session-report
description: "Summarize a Claude Code session into a structured report for handoff."
category: vendors
harness: claude
requires: "Claude Code plugin runtime"
role: shared
tags: [claude, vendor, harness]
backup_of: session-report
backup_path: /home/pablothethinker/.claude/plugins/marketplaces/claude-plugins-official/plugins/session-report/skills/session-report/SKILL.md
when_to_call: when running on the claude harness with its native tools; use universal/* via MCP otherwise
---

# claude-session-report (claude harness)
