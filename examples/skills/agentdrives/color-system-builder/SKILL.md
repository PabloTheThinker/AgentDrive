...
Given primary hex + roles (bg, surface, accent, ok, warn, error): produce tokens with **WCAG AA** pairs documented. Prefer AgentDrive chrome palette patterns when building TUI.
